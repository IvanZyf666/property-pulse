...
const PropertyCard = ({ property, id }: Props) => {
  ...
  return (
    <div className="property_card rounded-xl shadow-md relative">
      <Image
          ...
          <>
            {!id && (
              <Link
                ...
                className="details-btn h-[36px] bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg text-center text-sm m-1 lg:ml-auto"
              >
                Details
              </Link>
            )}
            {id && (
              <Link
                href={"/"}
                className="h-[36px] bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-lg text-center text-sm m-1 lg:ml-auto"
              >
                Go Home
              </Link>
            )}
